...
def two_circles():
    ...
    center1 = rg.Point(600, 650)
    center2 = rg.Point(400, 200)
    circle1 = rg.Circle(center1, 300)
    circle2 = rg.Circle(center2, 125)

    circle1.fill_color = 'cornsilk'
