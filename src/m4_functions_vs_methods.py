...
def try_methods_and_functions():
    ...
    """
    donatello = rg.SimpleTurtle()
    donatello.pen = rg.Pen('blue', 5)

    donatello.backward(150)

    donatello.speed = 1

    draw_many_squares(donatello, 2, 100, 30)

    donatello.speed = 5
    donatello.pen.color = 'red'
    draw_many_squares(donatello, 10, 50, 15)

    donatello.speed = 100
    donatello.pen.thickness = 35
    draw_many_squares(donatello, 8, 300, 60)

    donatello.pen = rg.Pen('black', 3)

    donatello.backward(200)

    donatello.draw_circle(30)

    donatello.draw_square(50)
